...
contains(NAMOCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += NAMOCOIN_NEED_QT_PLUGINS
...
# Gross ugly NAMO that depends on qmake internals, unfortunately there is no other way to do it.
...
HEADERS += src/qt/namocoingui.h \
    ...
    src/qt/namocoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/NamoCoin.cpp src/qt/namocoingui.cpp \
    ...
    src/qt/namocoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/namocoinstrings.cpp \
    src/qt/namocoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/NamoCoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/namocoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/NamoCoin-qt.rc
...
windows:RC_FILE = src/qt/res/NamoCoin-qt.rc
...
macx:ICON = src/qt/res/icons/NamoCoin.icns
macx:TARGET = "RGCoin-Qt"
