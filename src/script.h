...
#ifndef H_NAMOCOIN_SCRIPT
#define H_NAMOCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CnamocoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, RGCoin always counted CHECKMULTISIGs
